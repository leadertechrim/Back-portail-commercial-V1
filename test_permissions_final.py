#!/usr/bin/env python3
"""
Test final des permissions pour les offres
"""
...
def test_permissions_final():
    print("=== TEST FINAL DES PERMISSIONS ===")
    ...
    print("\n3. Connexion utilisateur normal...")
    user_login = {"email": "user_final@test.com", "password": "password123"}
    ...
    print("\n4. Création d'offre par l'utilisateur...")
    offre_user_data = {
        "intitulee": "Offre Test User Final",
        "lien": "https://example.com/offre-user-final",
    ...
    print("\n5. Création d'offre par l'admin...")
    offre_admin_data = {
        "intitulee": "Offre Test Admin Final",
        "lien": "https://example.com/offre-admin-final",
